                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="banner-txt">
                                ...
                                <h1>
                                    <span>Discover,</span> Collect, And Sell Your <span>Nft’s</span> In
                                    Marketplace
                                </h1>
                                <p>
                                ...
                                <div className="banner-link">
                                    <a href="collection.html" id="explore-link">
                                        Explore
                                    </a>
                        ...
                        <div className="col-lg-6">
                            <div className="banner-pic">
                                <img
                                    ...
                                    className="img-fluid men-slider"
                                />
                                <img src="assets/images/slide.jpg" className="slider-pix" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-4">
                            <div className="trending-box">
                                <div className="tredning-pic">
                                    <img src="assets/images/creator01.png" />
                                </div>
                        ...
                        <div className="col-lg-4">
                            <div className="trending-box">
                                <div className="tredning-pic">
                                    <img src="assets/images/creator02.png" />
                                </div>
                                <div className="tredning-txt">
                                    <h2>Zipcy’s</h2>
                                    <p>ETH-250.50</p>
                        ...
                        <div className="col-lg-4">
                            <div className="trending-box">
                                <div className="tredning-pic">
                                    <img src="assets/images/creator03.png" />
                                </div>
                                <div className="tredning-txt">
                                    <h2>Asuna Art</h2>
                                    <p>ETH-250.50</p>
                        ...
                        <div className="col-lg-4">
                            <div className="trending-box">
                                <div className="tredning-pic">
                                    <img src="assets/images/creator04.png" />
                                </div>
                                <div className="tredning-txt">
                                    <h2>Crypto Punk</h2>
                                    <p>ETH-250.50</p>
                        ...
                        <div className="col-lg-4">
                            <div className="trending-box">
                                <div className="tredning-pic">
                                    <img src="assets/images/creator05.png" />
                                </div>
                                <div className="tredning-txt">
                                    <h2>Mutant Ape</h2>
                                    <p>ETH-250.50</p>
                        ...
                        <div className="col-lg-4">
                            <div className="trending-box">
                                <div className="tredning-pic">
                                    <img src="assets/images/creator06.png" />
                                </div>
                                <div className="tredning-txt">
                                    <h2>Karafuru</h2>
                                    <p>ETH-250.50</p>
